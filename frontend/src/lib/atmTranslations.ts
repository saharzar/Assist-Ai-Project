...
export const atmTranslations: Record<LanguageCode, AtmTranslation> = {
  ...
  es: {
    ...
    successBody: "Ingresaste la contraseña correcta.",
  ...
  pt: {
    ...
    successBody: "Você digitou a senha correta.",
    ...
    successAssistant: "Muito bem. Você completou este passo da pratica de ATM.",
  ...
  fr: {
    ...
    successTitle: "Bravo !",
    successBody: "Tu as entré le bon mot de passe.",
    ...
    successAssistant: "Bravo. Tu as terminé cette étape d'entraînement DAB.",
