...
export const atmTranslations: Record<LanguageCode, AtmTranslation> = {
  ...
  tr: {
    ...
    wrongPinAssistant: (attempts) => `PIN yanlis. ${attempts} deneme hakkin kaldi.`,
    ...
    securityMessage: "Sistemde bir sorun var. Lutfen PIN kodunu yeniden gir.",
    securityTerminatedTitle: "Oturum sona erdi",
    securityTerminatedBody: "Guvenligin icin bu ATM oturumu sona erdi. Yeniden baslamadan once 10 saniye bekle.",
    securityTerminatedAssistant: "Guvenligin icin bu ATM oturumu sona erdi. Yeniden baslamadan once 10 saniye bekle.",
