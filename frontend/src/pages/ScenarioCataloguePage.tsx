...
export function ScenarioCataloguePage() {
  ...
  return (
    <section className="catalogue-page scenario-catalogue-page relative isolate flex w-full flex-1 flex-col overflow-hidden">
      ...
      <div className="catalogue-style-heading relative pt-1">
        <h1 className="landing-title-accent font-display text-3xl font-extrabold sm:text-4xl">
