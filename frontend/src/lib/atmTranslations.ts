...
export const atmTranslations: Record<LanguageCode, AtmTranslation> = {
  ...
  es: {
    ...
    securityTerminatedBody: "Por tu seguridad, esta sesion de cajero ha terminado. Espera 10 segundos antes de empezar de nuevo.",
    securityTerminatedAssistant: "Por tu seguridad, esta sesion ha terminado. Espera 10 segundos antes de empezar de nuevo.",
  ...
  de: {
    ...
    letterMismatchError: (attempts) => `Die Buchstaben stimmen nicht uberein. Bitte versuche es erneut. Noch ${attempts} Versuch${attempts === 1 ? "" : "e"}.`,
  ...
  pt: {
    ...
    letterMismatchError: (attempts) => `As letras nao coincidem. Tente novamente. Restam ${attempts} tentativa${attempts === 1 ? "" : "s"}.`,
    retryPinAfterLettersAssistant: (pin) => `Obrigado. Digite novamente a senha de pratica ${pin}`,
    wrongPinAssistant: (attempts) => `O PIN esta incorreto. Voce tem ${attempts} tentativa${attempts === 1 ? "" : "s"} restante${attempts === 1 ? "" : "s"}.`,
    ...
    securityTerminatedBody: "Para sua seguranca, esta sessao do ATM terminou. Aguarde 10 segundos antes de recomecar.",
    securityTerminatedAssistant: "Para sua seguranca, esta sessao terminou. Aguarde 10 segundos antes de recomecar.",
  ...
  fr: {
    ...
    letterMismatchError: (attempts) => `Les lettres ne correspondent pas. Reessaie. Il reste ${attempts} tentative${attempts === 1 ? "" : "s"}.`,
    ...
    securityCheckEyebrow: "Controle de securite",
    securityWaitTitle: "Veuillez patienter",
    securityNoticeEyebrow: "Avis de securite",
    securityMessage: "Il y a un probleme avec le systeme. Saisis a nouveau ton code PIN.",
    securityTerminatedTitle: "Session terminee",
    securityTerminatedBody: "Pour ta securite, cette session de distributeur est terminee. Attends 10 secondes avant de recommencer.",
    securityTerminatedAssistant: "Pour ta securite, cette session est terminee. Attends 10 secondes avant de recommencer.",
