...
export const atmTranslations: Record<LanguageCode, AtmTranslation> = {
  en: {
    ...
    withdrawalResultAssistant: (amount, remaining) => `You withdrew ${amount}. Your remaining balance is ${remaining}. Press Enter to finish.`,
  ...
  es: {
    ...
    withdrawalResultAssistant: (amount, remaining) => `Retiraste ${amount}. Tu saldo restante es ${remaining}. Pulsa Enter para finalizar.`,
  ...
  de: {
    ...
    withdrawalResultAssistant: (amount, remaining) => `Du hast ${amount} abgehoben. Dein verbleibendes Guthaben beträgt ${remaining}. Drücke Enter zum Abschluss.`,
  ...
  tr: {
    ...
    withdrawalResultAssistant: (amount, remaining) => `${amount} çektin. Kalan bakiyen ${remaining}. Bitirmek için Enter'a bas.`,
    successTitle: "Aferin!",
  ...
  pt: {
    ...
    withdrawalResultAssistant: (amount, remaining) => `Levantou ${amount}. O saldo restante é ${remaining}. Pressione Enter para terminar.`,
  ...
  fr: {
    ...
    withdrawalResultAssistant: (amount, remaining) => `Tu as retiré ${amount}. Ton solde restant est de ${remaining}. Appuie sur Enter pour terminer.`,
    successTitle: "Bravo !",
