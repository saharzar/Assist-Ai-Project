...
export const atmIntroductionTranslations: Record<LanguageCode, AtmIntroductionText> = {
  en: {
    ...
    voiceBody: "Hold a microphone button while speaking, then release it when you finish.",
  ...
  es: {
    ...
    voiceBody: "Mantén pulsado un botón de micrófono mientras hablas y suéltalo al terminar.",
  ...
  de: {
    ...
    voiceBody: "Halte eine Mikrofontaste beim Sprechen gedrückt und lasse sie los, wenn du fertig bist.",
  ...
  tr: {
    ...
    voiceBody: "Konuşurken mikrofon düğmesini basılı tut ve bitirdiğinde bırak.",
  ...
  pt: {
    ...
    voiceTitle: "Entrada de voz",
    voiceBody: "Mantenha um botão de microfone pressionado enquanto fala e solte-o quando terminar.",
  ...
  fr: {
    ...
    voiceBody: "Maintiens un bouton de microphone pendant que tu parles, puis relâche-le lorsque tu as terminé.",
