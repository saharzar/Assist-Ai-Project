...
export const atmTranslations: Record<LanguageCode, AtmTranslation> = {
  en: {
    ...
    insufficientFundsAssistant: (balance) => `Insufficient funds. Your available balance is ${balance}. Please choose a smaller amount.`,
  ...
  es: {
    ...
    insufficientFundsAssistant: (balance) => `Fondos insuficientes. Tu saldo disponible es ${balance}. Elige una cantidad menor.`,
  ...
  de: {
    ...
    insufficientFundsAssistant: (balance) => `Unzureichendes Guthaben. Verfügbar sind ${balance}. Wähle einen kleineren Betrag.`,
  ...
  tr: {
    ...
    insufficientFundsAssistant: (balance) => `Yetersiz bakiye. Kullanılabilir bakiyen ${balance}. Lütfen daha düşük bir tutar seç.`,
  ...
  pt: {
    ...
    insufficientFundsAssistant: (balance) => `Saldo insuficiente. O saldo disponível é ${balance}. Escolha um valor menor.`,
  ...
  fr: {
    ...
    insufficientFundsAssistant: (balance) => `Solde insuffisant. Ton solde disponible est de ${balance}. Choisis un montant plus faible.`,
